...
import com.dungzi.backend.domain.chat.Redis.RedisPublisher;
...
public class StompController {
    ...
    public void message(ChatMessageRequestDto messageSendDto, Message message) {
        ...
        redisPublisher.publish(new ChannelTopic(chatMessage.getChatRoom().getChatRoomId().toString()), chatMessage);
    }
